...
!endif
  ...
  # Add Q35 MCH device ID override
!ifdef $(QEMU_Q35_MCH_DEVICE_ID)
  MSFT:*_*_*_CC_FLAGS = /D INTEL_Q35_MCH_DEVICE_ID=$(QEMU_Q35_MCH_DEVICE_ID)
  INTEL:*_*_*_CC_FLAGS = /D INTEL_Q35_MCH_DEVICE_ID=$(QEMU_Q35_MCH_DEVICE_ID)
  GCC:*_*_*_CC_FLAGS = -DINTEL_Q35_MCH_DEVICE_ID=$(QEMU_Q35_MCH_DEVICE_ID)
!endif
  # Add Qemu bridge vendor ID override
!ifdef $(QEMU_PCI_BRIDGE_VENDOR_ID)
  MSFT:*_*_*_CC_FLAGS = /D QEMU_PCI_BRIDGE_VENDOR_ID_REDHAT=$(QEMU_PCI_BRIDGE_VENDOR_ID)
  INTEL:*_*_*_CC_FLAGS = /D QEMU_PCI_BRIDGE_VENDOR_ID_REDHAT=$(QEMU_PCI_BRIDGE_VENDOR_ID)
  GCC:*_*_*_CC_FLAGS = -DQEMU_PCI_BRIDGE_VENDOR_ID_REDHAT=$(QEMU_PCI_BRIDGE_VENDOR_ID)
!endif
